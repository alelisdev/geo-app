...
class AddCoord extends StatefulWidget {
  static const String routeName = '/add_coord';
  const AddCoord({Key? key}) : super(key: key);

  @override
  State<AddCoord> createState() => _AddCoordState();
}

class _AddCoordState extends State<AddCoord> {
                          ...
                          FlatButton(
                            ...
                            onPressed: () async {
                              ...
                              ScopedModel.of<AppModel>(context).getUserData(res['id'].toString())
                                ...
                                _navigator?.pop();
                                _navigator?.pushReplacementNamed('/profile', arguments: UserId(id: res['id'].toString()));
                              });
                            },
                          ),
                          FlatButton(
